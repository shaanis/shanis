...
const FAQSection = () => {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer:
        "CasaAura is a home decor e-commerce platform I built using React, Node, and MongoDB. It handles 100+ daily visitors with features like Razorpay integration (increasing checkout completion by 25%), product filtering, wishlist, and cart management. Live demo available at https://cas4Aura.netlify.app",
    ...
    },
    {
      ...
      answer:
        "Yes, I developed a Club Management App using Flutter and Node.js with features like member registration, fee tracking, expense management, role-based authentication, Cloudinary integration for file storage, and server-side PDF report generation.",
      icon: <FiCode className="text-xl" />,
      category: "Technical",
    },
    {
      ...
      answer:
        "Tripeloo is a resort and activities booking web app with role-based dashboards for admins and vendors across 20+ destinations. I implemented real-time search and filtering (improving data fetch time by 40%), secure payments, and booking verification for 50+ users. Demo: https://tripeloodemo.netlify.app",
      icon: <FiGlobe className="text-xl" />,
      category: "Projects",
    },
    {
      ...
      answer:
        "I typically respond to emails within 24 hours. For urgent matters, you can reach me via phone at +91 7356379172. I'm always open to discussing new opportunities and creative projects.",
    ...
    },
    {
      ...
      answer:
        "I work with REST APIs, JWT authentication, Git/GitHub, deployment platforms (Netlify, Vercel, Render), and integrations like Razorpay payment gateway, Google APIs, and Cloudinary for media management. I also use Tailwind CSS and Bootstrap for frontend development.",
      icon: <FiCode className="text-xl" />,
      category: "Technical",
    },
    {
      ...
      answer:
        "I completed a MERN Stack Internship at Luminar Technolab Kochi (Aug 2024 – Mar 2025) and hold a BSc in Computer Science from University of Calicut (Aug 2021 – Mar 2024). This combination of formal education and practical training has equipped me with strong fundamentals and real-world experience.",
      icon: <FiBriefcase className="text-xl" />,
      category: "Education",
    },
  ];
  ...
  return (
    <div
      id="faq"
      className="w-full bg-gradient-to-b from-gray-50 to-white py-24 px-4 sm:px-8 overflow-hidden"
    >
      {/* Decorative elements */}
      ...
      <div className="relative max-w-6xl mx-auto">
        ...
        >
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto leading-relaxed">
            Get answers to common questions about my experience, projects, and
            services
          </p>
        ...
        >
          <div className="p-8 rounded-3xl bg-gradient-to-br from-black to-gray-900 text-white shadow-2xl">
            ...
            <p className="text-gray-300 mb-6 max-w-2xl mx-auto">
              I'm always happy to discuss your specific requirements or provide
              more detailed information about my projects and experience.
            </p>
        ...
        >
          ...
          <div className="text-center p-6 rounded-2xl bg-white/80 backdrop-blur-sm border border-gray-200">
            ...
            <div className="text-gray-600 mt-2">Responsive Design</div>
          </div>
          <div className="text-center p-6 rounded-2xl bg-white/80 backdrop-blur-sm border border-gray-200">
            <div className="text-3xl font-bold text-black">24/7</div>
<div className="text-gray-600 mt-2">Support Ready</div>
          </div>
        </motion.div>
      </div>
    </div>
